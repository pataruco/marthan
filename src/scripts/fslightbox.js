  ...
  (() => {
    ...
    function I(t) {
      var n = t.core,
        ...
        h = t.ss,
        f = t.t,
        p = t.thumbsSwipingProps,
        b = t.z;
      (this.i = 0),
        (this.runActions = () => {
          (this.i = 1),
            r.container.classList.add(m),
            i.removeListeners(),
            h.r(),
            l.exitFullscreenOnClose && t.ifs && c.x(),
            b.r(),
            f(() => {
              this.i = 0;
              for (var n = 0; n < t.ts.length; n++) clearTimeout(t.ts[n]);
              for (t.ts = [], n = 0; n < d.length; n++) d[n] = 0;
              (u.i = !1),
                p && (p.i = !1),
                r.container.classList.remove(m),
    ...
    function O(t) {
      var e = t.data,
        ...
        c = r.thumbsWrappers;
      (this.runNoSwipeActionsForEvent = (t) => {
    ...
    function X(t) {
      ...
      (this.m = (o) => {
        i.qps(), t.p.i && e(B, R)(o), n.disableThumbs || r.listener(o);
      }),
        (this.u = (e) => {
          !((t, e) => {
            var n = t.p,
    ...
    function j(t, e, n, o) {
      ...
      i.setAttributeNS(null, 'viewBox', e), i.setAttributeNS(null, 'class', o);
      var s = document.createElementNS('http://www.w3.org/2000/svg', 'path');
      return (
        s.setAttributeNS(null, 'class', 'fslightboxsvgp'),
        s.setAttributeNS(null, 'd', n),
        i.appendChild(s),
        t.appendChild(i),
        i
      );
    ...
    function V(t, e) {
      ...
      return (
        (o.className = 'fslightboxb '.concat(n, 'toolbar-button ').concat(r)),
        (o.title = e),
        t.appendChild(o),
        o
      );
    ...
    function U(t, e, n) {
      var o = V(t, e.title);
      (o.onclick = n), j(o, e.viewBox, e.d, e.class);
    }
    function Z(t) {
          ...
          d || U(f, h.thumbs, c.toggleThumbs),
            ...
            ((t, e) => {
              var n = t.props.toolbarButtons.slideshow,
                ...
                r = V(e, o.title);
              r.onclick = s.t;
              var a = j(r, o.viewBox, o.d, o.class);
              function c(t) {
                (r.title = t.title),
                  a.setAttributeNS(null, 'viewBox', t.viewBox),
                  a.setAttributeNS(null, 'class', t.class),
            ...
            ((t, e) => {
              if (!t.hfs) {
                var n = t.fs,
                  o = t.props.toolbarButtons.fullscreen,
                  i = o.enter,
                  s = o.exit,
                  r = V(e, i.title),
                  a = j(r, i.viewBox, i.d, i.class);
                (t.fso = () => {
                  (t.ifs = 1), c(s);
                }),
                  (t.fsx = () => {
    ...
    function $(t) {
      ...
      (i.className = 'fslightboxswc '.concat(c, ' ').concat(s)),
        ...
        i.addEventListener('pointerdown', o(_, R)),
        (t.swc = i);
    ...
    function K(t, e) {
      ...
      (c !== e || (n && !u)) && (h += ' fslightboxx'),
        ...
        a[e] instanceof Element ? d.appendChild(a[e]) : (d.innerHTML = a[e]),
        l.appendChild(d),
        (i[e] = l),
        s.appendChild(l);
    }
    function Q(t, e) {
      ...
      (o[a] = document.createElement('div')),
        ...
        ((t, e) => {
          ...
          (n.className = 'fslightboxb '.concat(l, ' ').concat(r)),
            j(n, e.viewBox, e.d, e.class),
            t.appendChild(n);
        })(o[a], c),
    ...
    function et(t) {
      var e,
        ...
        o = 0,
        i = {};
      (this.getSourceTypeFromLocalStorageByUrl = (t) => (e[t] ? e[t] : s(t))),
        (this.handleReceivedSourceTypeForUrl = (t, n) => {
          if (
            !1 === i[n] &&
    ...
    var nt = 'image',
      ...
      rt = 'invalid';
    function at(t, e, n, o) {
      var s = (t.data, t.elements.sources),
        r = n / o,
        a = 0,
        c = null;
      (this.s = () => {
    ...
    function ct(t, e) {
      var o = t.elements.sources,
        i = t.isl,
        s = t.la,
        r = t.props,
        a = r.initialAnimation,
        c = r.onSourceLoad,
        l = t.resolve,
        d = t.saw,
        h = t.sew,
        f = t.sz;
      function p(t, n) {
        (f[e] = l(at, [e, t, n])), f[e].s();
      }
      this.a = (r, l) => {
        (i[e] = !0),
          o[e].classList.add(u),
          d[e].classList.add(a),
          d[e].removeChild(d[e].firstChild),
          requestAnimationFrame(() => {
            requestAnimationFrame(() => {
              h[e].classList.add('fslightboxtt');
            });
          }),
          p(r, l),
          s.s(e),
    ...
    function ht(t, e) {
      var n = t.ap,
        o = t.collections.sourceLoadHandlers,
        i = t.elements.sources,
        s = t.props.sources,
        r = t.saw,
      ...
      (i[e] = a),
        (a.className = 'fslightboxs fslightboxv'),
        (a.src = s[e]),
        (a.onloadedmetadata = (t) => {
          o[e].handleVideoLoad(t);
        }),
        (a.controls = !0),
        (a.autoplay = n.i(e)),
        lt(t, e),
        a.appendChild(c),
        setTimeout(o[e].handleNotMetaDatedVideoLoad, 3e3),
        r[e].appendChild(a);
    }
    function ft(t, e) {
      var n = t.ap,
        ...
        r = i.saw,
        a = t.props.sources,
        c = ((r = t.saw), document.createElement('iframe')),
        u = a[e],
        l = u.split('?')[1];
      (s[e] = c),
        (c.className = 'fslightboxs fslightboxyt'),
        (c.src = 'https://www.youtube.com/embed/'
          .concat(
            u.match(
          ...
          .concat(l || '')
          .concat(n.i(e) ? '&mute=1&autoplay=1' : '', '&enablejsapi=1')),
        (c.allowFullscreen = 1),
        lt(t, e),
        r[e].appendChild(c),
        o[e].handleYoutubeLoad();
    }
    function pt(t, e) {
      var n = t.collections.sourceLoadHandlers,
        o = t.elements.sources,
    ...
    function bt(t, e, n) {
      ...
      (a.className = 'fslightboxtd'), e.appendChild(a);
    }
    function gt(t, e, n) {
      var o = t.elements,
        i = o.thumbsWrappers,
    ...
    function xt(t) {
      var e = t.core.thumbsRenderDispatcher,
        ...
        s = o.sources,
        a = o.thumbs;
      this.buildThumbForTypeAndIndex = (o, c) => {
        var u;
        (u = a[c]
          ? () => gt(t, c, a[c])
          : o === nt
    ...
    function vt(t) {
      var e,
        ...
        a = t.resolve;
      r || (e = a(xt)),
        (this.runActionsForSourceTypeAndIndex = (n, c) => {
          var u;
    ...
    function wt(t, e, n) {
      var o = t.props,
        ...
        s = o.type,
        r = o.sources;
      (this.getTypeSetByClientForIndex = (t) => {
        var e;
        return i && i[t] ? (e = i[t]) : s && (e = s), e;
      }),
        (this.retrieveTypeWithXhrForIndex = (t) => {
          !((t, e) => {
    ...
    function yt(t) {
      var e = t.props.sources,
        ...
        o = t.stageIndexes,
        i = e.length - 1;
      (n.getPreviousSlideIndex = () => (0 === o.current ? i : o.current - 1)),
        (n.getNextSlideIndex = () => (o.current === i ? 0 : o.current + 1)),
        (n.u =
          0 === i
            ? () => {}
            : 1 === i
    ...
    function Ct(t) {
      ...
      function M() {
        ...
        (W = !0),
          ...
          (r || a.length > 0) && (t.loc = 1),
          (h.unloadedThumbsCount = m.length),
          l ||
            ((h.isThumbing = d),
            ((t) => {
              var e = t.core,
              ...
              (n.isThumbing = i.showThumbsOnMount),
                ...
                ((t) => {
                  var e = t.core.thumbsRenderDispatcher,
                    ...
                    i = !1,
                    s = 0;
                  (e.addFunctionToToBeRenderedAtIndex = (t, e) => {
                    (o[e] = t), s++;
                  }),
                    (e.renderThumbsIfNotYetAndAllTypesDetected = () => {
                      if (!i && s === n.length) {
                        i = !0;
                ...
                ((t) => {
                  ...
                  (n.transformToCurrent = () => {
                    ...
                    (n.transformToCurrentWithTransition = () => {
                      i.thumbsInnerWidth > innerWidth &&
            ...
            !((t) => {
              ...
              ((t) => {
                var e = t.core,
                  ...
                  o = e.st,
                  i = t.elements;
                (n.removeFromEachElementClassIfContains = (t, e) => {
                  for (var n = 0; n < i[t].length; n++) z(i[t][n], e);
                }),
                  (n.stagedRemovalAndOutstagedAddingOfClassIfContains = (
                    t,
                    e,
                  ) => {
              ...
              ((t) => {
                ...
                function s(t) {
                  for (var e = 0; e < n.length; e++) document[t](n[e], r);
                }
                function r() {
              ...
              ((t) => {
                ...
                function g(t) {
                  m(t), e.isThumbing ? (w(t), u && x(t)) : x(t);
                }
                function x(t) {
                  v(t, c.current);
                }
              ...
              ((t) => {
                var e = t.core.pointeringBucket;
                t.elements,
                  (e.runSwipingDownActionsForPropsAndEvent = (t, e) => {
                    (t.i = !0), (t.downScreenX = e.screenX), (t.swipedX = 0);
                  }),
                  (e.runSwipingMoveActionsForPropsAndEvent = (e, n) => {
                    S(t.h, 'fslightboxcg'),
                      (e.swipedX = n.screenX - e.downScreenX);
                  }),
                  (e.runSwipingTopActionsForPropsAndEvent = (e) => {
              ...
              ((t) => {
                ...
                (c.r = () => {
                  ...
                  (c.s = (t) => {
                    ...
                    if (e) {
                      var n = e.d(),
                        o = n[0] + n[1];
                      if (v[t]) {
                        var s = e.g(innerHeight * x - v[t]);
                        (w[t] = (s[0] + s[1]) / o),
                          (L[t] = -(v[t] - innerHeight / 2 + s[1] / 2)),
                          L[t] > 0 && (L[t] = 0);
                      }
                      if (!i) {
                        if (p && v[t]) {
                  ...
                  (c.rt = () => {
                    ...
                    for (var t = 0; t < e; t++)
                      o.thumbsInnerWidth += b[t].offsetWidth + 8;
                    n.transformToCurrent();
                  });
              })(t),
              F(t),
              ...
              ((t) => {
                ...
                (i.changeTo = (n) => {
                  ...
                  m.r(),
                    ...
                    h.u(),
                    t.sn(n + 1),
                    u || (a.t(i, n), r.transformToCurrentWithTransition()),
                    s.displaySourcesWhichShouldBeDisplayed(),
          ...
          ((t) => {
            (t.h = document.createElement('div')),
              (t.h.className = 'fslightboxh '.concat(s, ' ').concat(c));
          })(t),
          Z(t),
          ((t) => {
          ...
          m.length > 1 && (Q((e = t), 'previous'), Q(e, 'next')),
          l ||
            ((t) => {
              ...
              var i,
                ...
                a = g;
              function u() {
                (r = !0), (i = J(n.thumbsContainer)).classList.add(x);
              }
              o.isThumbing ? u() : (a += ' fslightboxx'),
                (e.appendThumbsLoaderIfNotYet = () => {
                  r || u();
                }),
                (e.hideThumbsLoader = () => {
    ...
    return (
      (window.FsLightbox = function () {
        ...
        (this.props = {
          ...
          Ct(this),
          (this.close = () => t.core.lightboxCloser.close());
      }),
